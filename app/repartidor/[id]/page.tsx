...
export default async function RepartidorDetallePage({ params }: Params) {
    ...
    const pedido = pedidoRaw ? { ...pedidoRaw, pedidoId: pedidoRaw.id, repartidorId: pedidoRaw.repartidorId ?? undefined, datosEntrega: ('datosEntrega' in pedidoRaw ? pedidoRaw.datosEntrega as { [key: string]: any; direccion?: string } | null | undefined : undefined), items: Array.isArray(pedidoRaw.items) ? pedidoRaw.items : [] } : null;
